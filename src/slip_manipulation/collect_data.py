...
class DataCollector():
    def __init__(self):
        ...
        self.tac0_data_arr = [['secs','gfX','gfY','gfZ','fTotal','gtX','gtY','gtZ']]
        self.tac1_data_arr = [['secs','gfX','gfY','gfZ','fTotal','gtX','gtY','gtZ']]
    ...
    def sensor_callback(self, data, sensor_num):
        ...
        if sensor_num == 0:
            ...
            if self.tac0_data.is_contact:
                temp = [self.tac0_data.header.stamp.secs, self.tac0_data.gfX, self.tac0_data.gfY, self.tac0_data.gfZ,
                np.abs(self.tac0_data.gfX) + np.abs(self.tac0_data.gfY) + np.abs(self.tac0_data.gfZ),
            ...
            if self.tac1_data.is_contact:
                temp = [self.tac1_data.header.stamp.secs, self.tac1_data.gfX, self.tac1_data.gfY, self.tac1_data.gfZ,
                np.abs(self.tac1_data.gfX) + np.abs(self.tac1_data.gfY) + np.abs(self.tac1_data.gfZ),
