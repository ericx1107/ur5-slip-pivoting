...
if __name__ == "__main__":
    ...
    while True:
        ...
        # demo.grasp_goal = rospy.wait_for_message('/slip_manipulation/grasp_pose', PoseStamped)  # get this in some other way #########
        # demo.grasp_goal.pose.position.z += demo.ee_offset
        demo.grasp_goal = demo.ur5.arm.get_current_pose()
        ...
        print("planning")
        waypoints, start_pose = demo.arc.plan_arc_trajectory(radius=0.75)
